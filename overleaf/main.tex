...
Gene Asah2 is located near the center of Chromosome 19 and has a local expression QTL with a peak at $$\_$$ \todo[inline]{add peak position} on Chromosome 19. We identified a set of 79 other expression traits that map to the 20-Mb region centered on the peak for Asah2, at 32.1 Mb. Each trait among the 79 maps to Chromosome 19 with a univariate LOD of at least 10. 
